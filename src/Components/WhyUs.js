const WhyUs = () => {
    return (
        <div className="container3" id="Why_Us">
        <strong>
        <h2 className="article3"><strong>Why Us?</strong></h2>
        <p className="article3a">Mengapa harus pilih Binar Car Rental?</p>
        <div className="card-1">
            <div className="card1a">
                ...
                <div className="text">               
                        <h5><strong>Mobil Lengkap</strong></h5>
            ...
            <div className="card1a">
                ...
                <div className="text">               
                        <h5><strong>Harga Murah</strong></h5>
            ...
            <div className="card1a">
                ...
                <div className="text">               
                        <h5><strong>Layanan 24 Jam</strong></h5>
            ...
            <div className="card1a">
                ...
                <div className="text">               
                        <h5><strong>Sopir Profesional</strong></h5>
